...
class IpfsTests: XCTestCase {
  ...
  func testGetCID() async throws {
    ...
    XCTAssertTrue(message.signature.hasPrefix("-----BEGIN PGP SIGNATURE-----"), "signature should begin with appropriate prefix");
    XCTAssertTrue(message.signature.hasSuffix("-----END PGP SIGNATURE-----\n"), "signature should end with appropriate suffix");
    XCTAssertTrue(message.encryptedSecret.hasPrefix("-----BEGIN PGP MESSAGE-----"), "encryptedSecret should begin with appropriate prefix");
    XCTAssertTrue(message.encryptedSecret.hasSuffix("-----END PGP MESSAGE-----\n"), "encryptedSecret should end with appropriate suffix");
  }
