...
class SignerTests: XCTestCase {
  ...
  func testSignerCanDoEIP191Sig() async throws {
    ...
    XCTAssertEqual(
      sig,
      "eip191:0x9d71faa2582414160f3bc5b62bd8204b45e8ce60e42e034065366c27ed4f456d406ed157fec97db7cedb070f3488a0e78b6b59467063fab11aee6a2bf8233b131b"
    )
  }
  ...
  func testSignerCanDoEIP191SigV2() async throws {
    ...
    let msg =
      "Create Push Profile \n252f10c83610ebca1a059c0bae8255eba2f95be4d1d7bcfa89d7248a82d9f111"
    let sig = try signer.getEip191Signature(message: msg, version: "v2")
