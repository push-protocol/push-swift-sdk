...
extension PushChat {
    ...
    public struct CreateGroupOptions {
        ...
        public init(
            ...
            if let adminIndex2 = self.admins.firstIndex(of: self.creatorAddress) {
                self.admins.remove(at: adminIndex2)
            }
            ...
            self.admins = walletsToPCAIP10(accounts: self.admins)
        }
    }
